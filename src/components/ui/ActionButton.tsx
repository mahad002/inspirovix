...
export const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  return (
    ...
    >
      <motion.div
        className={`px-6 py-3.5 rounded-lg font-semibold flex items-center justify-center gap-2 relative preserve-3d shadow-xl group-hover:shadow-2xl transition-shadow text-sm sm:text-base ${
